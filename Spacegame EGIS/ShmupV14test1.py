...
#All credits go to Hoss and Chris Bradfield
#Chris Bradfield's tutorials helped craft this game!
import pygame
import random
from os import path
...
def show_go_screen(): #Game over show_go_screen
    screen.blit(background, background_rect)
    draw_text(screen, "Space Invaders Prototype", 64, WIDTH / 2, HEIGHT /4)
    ...
    draw_text(screen, "A Turtle Games production", 18, WIDTH /2, HEIGHT * 3/7)
    draw_text(screen, "Credits:", 15, WIDTH /2, HEIGHT * 3/4)
    draw_text(screen, "Hoss Kholgi: Mentor", 15, WIDTH /2, HEIGHT * 4/5)
    draw_text(screen, "Chris Bradfield - Tutorials: Inspiration", 15, WIDTH /2, HEIGHT * 5/6)
